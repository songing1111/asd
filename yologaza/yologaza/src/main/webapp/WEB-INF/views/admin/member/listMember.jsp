...
<script>
    $(function() {        
        ...
        $('input[name="daterange"]').daterangepicker({
	        ...
	        $('#dateApplyBtn').click(function(){
	    		window.location.href='${contextPath}/admin/member/listMember.do?date1='+date1+'&date2='+date2+'&auth='+auth;
	    	});
        });
    });
    ...
    $.fn.type = function(){
        ...
        $('#searchBtn').click(function(){
    		window.location.href='${contextPath}/admin/member/listMember.do?date1='+date1+'&date2='+date2+'&auth='+auth+'&query='+query+'&type='+type;
    	});
	}
	  ...
	  <div class="admin_main_box con" style="width:1024px">
	    ...
	    <div class="adminCustomer">
	      <div class="adminCustomer_box">
	        <a id="text1">전체 회원 관리</a>
	        <div class="button_div">
	          <button type="button" onclick="location.href='${contextPath}/admin/member/listMember.do?date1=0&date2=0&auth=${auth}'">전체</button>
	          <button type="button" onclick="location.href='${contextPath}/admin/member/listMember.do?date1=${today1-7776000}&date2=${today2}&auth=${auth}'">90일</button>
	          <button type="button" onclick="location.href='${contextPath}/admin/member/listMember.do?date1=${today1-2592000}&date2=${today2}&auth=${auth}'">30일</button>
	          <button type="button" onclick="location.href='${contextPath}/admin/member/listMember.do?date1=${today1-604800}&date2=${today2}&auth=${auth}'">1주</button> 
	          <button type="button" onclick="location.href='${contextPath}/admin/member/listMember.do?date1=${today1}&date2=${today2}&auth=${auth}'">오늘</button>
	        ...
	        <div class="auth_div">
	          <button type="button" onclick="location.href='${contextPath}/admin/member/listMember.do?date1=${date1}&date2=${date2}&auth='">전체</button>
	          <button type="button" onclick="location.href='${contextPath}/admin/member/listMember.do?date1=${date1}&date2=${date2}&auth=3'">관리자</button>
	          <button type="button" onclick="location.href='${contextPath}/admin/member/listMember.do?date1=${date1}&date2=${date2}&auth=2'">사업자</button>
	          <button type="button" onclick="location.href='${contextPath}/admin/member/listMember.do?date1=${date1}&date2=${date2}&auth=1'">사용자</button>
